...
6. For a big or wide change, fan out. Spawn several independent subagents on the same question (different models if the harness offers them) and merge the answers. Independent passes catch different real bugs.
