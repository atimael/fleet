...
| <new pattern, no existing skill is a real home> | <draft a new skill in the skills source repo> | <new skill: <kebab-name>> |
...
For each item, describe the pattern, what was hit, and the suggested mechanism. The parent appends each to `BACKLOG.md` at the skills source repo root.
