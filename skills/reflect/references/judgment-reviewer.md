...
- `Read` tool calls against any `SKILL.md` file (project `.claude/skills/` or `.codex/skills/`, user-level `~/.claude/skills/`, `~/.codex/skills/`, `~/.agents/skills/`, or plugin-installed paths)
